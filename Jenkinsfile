    ...
    stages {
      ...
      post {
            always {
                  ...
                  publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: '', reportFiles: 'report.html', reportName: 'HTML Report', reportTitles: 'Gokul Test report', useWrapperFileDirectly: true])
